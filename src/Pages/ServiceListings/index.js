...
function ServiceListings() {
    const dummyData = [
        ...
        { id: 2,Sr_no :2, FirstName: 'John Doe',LastName:'Doe', Username:'johndoe@me' , email: 'john@example.com' , country:"India" , phone_no:'9702270208' , dob:'28/09/2001',createddate:"28/09/2001" ,UF:'InActive'  },
        { id: 3,Sr_no :3, FirstName: 'John Doe',LastName:'Doe', Username:'johndoe@me' , email: 'john@example.com' , country:"India" , phone_no:'9702270208' , dob:'28/09/2001',createddate:"28/09/2001" ,UF:'IsActive' },
    ...
    return <>
        ...
        <div className="title_dashboard">
            ...
            <div className="title"><h1 className="titleh1">Service listings</h1></div>
        </div>

        <div className="totem_buttons">
            <button className="totem_button">Service Required</button>
            <button className="totem_button">Service Available</button>
            <button className="totem_button_terminate">Terminate Required Service</button>
            <button className="totem_button">Restore Service</button>
